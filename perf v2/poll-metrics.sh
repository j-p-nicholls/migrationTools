...
echo "Timestamp,CPU_Usage_Percent,Memory_Committed_Percent,Disk_Time_Percent" > "${OUTFILE}"

echo "Polling ${HOSTNAME_SHORT} for ${DURATION_MIN} minute(s), ${INTERVAL_SEC}s interval, ${SAMPLE_COUNT} sample(s)..."
